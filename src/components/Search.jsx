...
const Search = () => {
    ...
    // ** handling search functionality and redirecting to details page
    const handleSubmit = (e) => {
        e.preventDefault();
        // Check if searchValue is empty or consists only of whitespace
        if (!searchValue.trim()) {
            // Set error message
            setErrorMessage('Please enter a Pokémon Name or Id to search.');
            return; // Prevent form submission
        }
        // Reset error message and proceed with navigation if input is valid
        setErrorMessage('');
